...
// Create shape references pointing to different objects Shape shape;
shape = new Circle(); shape.draw(); shape.erase();
shape = new Triangle(); shape.draw(); shape.erase();
shape = new Square(); shape.draw(); shape.erase();
}
}
